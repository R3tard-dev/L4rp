...
public class Button {
    ...
    protected final GuiFrame    parent;
    ...
    public Button(GuiFrame parent, int height, String description) {
        this.setting     = null;
        this.parent      = parent;
        this.height      = height;
    ...
    public Button(Setting<?> setting, GuiFrame parent, int height, String description) {
