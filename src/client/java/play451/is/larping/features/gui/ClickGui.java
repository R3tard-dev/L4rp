...
public class ClickGui extends Screen {
    ...
    private void renderSidebar(DrawContext context, int mouseX, int mouseY) {
        ...
        for (ModuleCategory category : ModuleCategory.values()) {
            ...
            context.drawText(this.textRenderer, category.getName(), 
                x + 20, categoryY + 13, textColor, false);
    ...
    private void renderContentArea(DrawContext context, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < modules.size(); i++) {
            ...
            int settingsX = moduleX + moduleWidth - 20;
            int settingsY = moduleY + 8;
            int settingsSize = 14;
            ...
            context.fill(settingsX + 8, settingsY + 6, settingsX + 10, settingsY + 8, TEXT_PRIMARY);
            context.fill(settingsX + 6, settingsY + 8, settingsX + 8, settingsY + 10, TEXT_PRIMARY);
